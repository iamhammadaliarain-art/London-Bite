...
export const setManagementBranchLocation = (token: string, latitude: number, longitude: number, geofenceMeters = 50) => lbRpc("lb_management_set_branch_location", { p_latitude: latitude, p_longitude: longitude, p_geofence_meters: geofenceMeters }, token);
